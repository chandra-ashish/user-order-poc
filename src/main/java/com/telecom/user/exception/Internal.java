...
public class Internal   {
  ...
  @JsonProperty("code")
  private CodeEnum code = CodeEnum.INTERNAL;

  public Internal message(String message) {
  ...
  **/
  ...
  public Internal code(CodeEnum code) {
    this.code = code;
    return this;
  }
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "Unknown server error.Typically a server bug.")
  @NotNull
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.message, internal.message) &&
        Objects.equals(this.code, internal.code);
  }
